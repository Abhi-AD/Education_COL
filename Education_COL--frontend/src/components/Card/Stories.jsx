const Stories = () => {
     ...
     return (
          <div id="carouselExample" className="carousel slide mx-auto p-4 bg-main" data-bs-ride="carousel">
                              ...
                              <div className="row">
                                   {cardData.slice(index * 4, index * 4 + 4).map((item, idx) => (
                                        <div key={index * 4 + idx} className="col-md-3">
                                             <div className="card border-0 shadow d-flex justify-content-center align-items-center" style={{ height: '13rem' }}>
                                                  {item}
                                             </div>
                                        </div>
                                   ))}
